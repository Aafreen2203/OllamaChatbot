    ...
    <div className="font-sans">
      ...
      <div ref={layoutRef} className="h-screen bg-gray-900 flex overflow-hidden relative">
        ...
        <button
          ...
          className="fixed top-4 left-4 z-50 md:hidden p-2 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-200"
        >
