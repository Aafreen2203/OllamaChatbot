            ...
            >
              <div className="flex items-center justify-between">
                ...
                {editingChatId === chat.id ? (
                  ...
                  <div className="flex items-center space-x-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200 flex-shrink-0">
                    <button
                    ...
                    <button
                      className="p-1.5 md:p-2 rounded-lg hover:bg-red-100/80 dark:hover:bg-red-900/30 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-all duration-200 backdrop-blur-sm"
                      onClick={(e) => {
                        e.stopPropagation()
